...
When I do the registration for my user by entering username as "aashishk17" and email address as 
"aashish.khetarpal.07@gmail.com" and password as "cypresstutorials"
Then I do the assertions for Register Button and Register successfully by entering new password 
...
Then I do the login with same credentials used above "aashish.khetarpal.07@gmail.com" and "cypresstutorials"
